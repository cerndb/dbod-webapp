...
public class RescueController extends Window {
     ...
     */
    public RescueController (DODInstance inst, DODInstanceDAO instanceDAO) throws InterruptedException {        
        ...
        this.setTitle(Labels.getLabel(DODConstants.LABEL_RESCUE_TITLE) + " " + instance.getDbName());
        ...
        //Main message
        Label message = new Label(Labels.getLabel(DODConstants.LABEL_RESCUE_MESSAGE));
    ...
    private void doAccept() {
        ...
        if (instanceDAO.rescue(instance) == 1) {
            ...
            showError(DODConstants.ERROR_RESCUING_INSTANCE);
        }
        this.detach();
    }
