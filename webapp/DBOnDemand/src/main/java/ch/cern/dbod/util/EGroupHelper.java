...
import ch.cern.dbod.ws.egroups.*;
...
public class EGroupHelper {
    ...
    public boolean addEgroupToOEM(String instanceName, String egroup) {
        ...
        return createEGroup(CommonConstants.OEM_PDB_EGROUP_PREFIX + instanceName, instanceName, info.getCcid(), false)
                            && addEgroupAsMember(CommonConstants.OEM_PDB_EGROUP_PREFIX + instanceName, egroup)
                            && addEgroupAsMember(CommonConstants.OEM_EGROUP, CommonConstants.OEM_PDB_EGROUP_PREFIX + instanceName);
    }
    ...
    public boolean removeEgroupFromOEM(String instanceName) {
        return removeEgroupAsMember(CommonConstants.OEM_EGROUP, CommonConstants.OEM_PDB_EGROUP_PREFIX + instanceName)
                && deleteEgroup(CommonConstants.OEM_PDB_EGROUP_PREFIX + instanceName);
    }
    ...
    public boolean changeEgroupInOEM(String instanceName, String oldEgroup, String newEgroup) {
        return removeEgroupAsMember(CommonConstants.OEM_PDB_EGROUP_PREFIX + instanceName, oldEgroup)
                && addEgroupAsMember(CommonConstants.OEM_PDB_EGROUP_PREFIX + instanceName, newEgroup);
    }
}
