...
ALTER TABLE dod_instance_changes 
    ADD CONSTRAINT pk_instance_changes PRIMARY KEY ( username, db_name, attribute, change_date ) ;
...
ALTER TABLE dod_instance_changes 
    ADD CONSTRAINT dod_instances_changes FOREIGN KEY 
    ( 
     username,
     db_name
    ) 
