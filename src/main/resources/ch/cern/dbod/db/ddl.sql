...
CREATE SEQUENCE DBONDEMAND.COMMAND_DEFINITION_ID_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER DBONDEMAND.COMMAND_DEFINITION_ID_TRG BEFORE
  INSERT ON DBONDEMAND.COMMAND_DEFINITION FOR EACH ROW WHEN (NEW.ID IS NULL) BEGIN :NEW.ID := DBONDEMAND.COMMAND_DEFINITION_ID_SEQ.NEXTVAL;
END;
/

CREATE SEQUENCE DBONDEMAND.COMMAND_PARAM_ID_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER DBONDEMAND.COMMAND_PARAM_ID_TRG BEFORE
  INSERT ON DBONDEMAND.COMMAND_PARAM FOR EACH ROW WHEN (NEW.ID IS NULL) BEGIN :NEW.ID := DBONDEMAND.COMMAND_PARAM_ID_SEQ.NEXTVAL;
END;
/

CREATE SEQUENCE DBONDEMAND.INSTANCE_ID_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER DBONDEMAND.INSTANCE_ID_TRG BEFORE
  INSERT ON DBONDEMAND.INSTANCE FOR EACH ROW WHEN (NEW.ID IS NULL) BEGIN :NEW.ID := DBONDEMAND.INSTANCE_ID_SEQ.NEXTVAL;
END;
/

CREATE SEQUENCE DBONDEMAND.INSTANCE_CHANGE_ID_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER DBONDEMAND.INSTANCE_CHANGE_ID_TRG BEFORE
  INSERT ON DBONDEMAND.INSTANCE_CHANGE FOR EACH ROW WHEN (NEW.ID IS NULL) BEGIN :NEW.ID := DBONDEMAND.INSTANCE_CHANGE_ID_SEQ.NEXTVAL;
END;
/

CREATE SEQUENCE DBONDEMAND.JOB_ID_SEQ START WITH 1 NOCACHE ORDER ;
CREATE OR REPLACE TRIGGER DBONDEMAND.JOB_ID_TRG BEFORE
  INSERT ON DBONDEMAND.JOB FOR EACH ROW WHEN (NEW.ID IS NULL) BEGIN :NEW.ID := DBONDEMAND.JOB_ID_SEQ.NEXTVAL;
END;
/
