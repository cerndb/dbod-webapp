...
function drawGraph (values) {    
    ...
    var end = new Date(values[values.length - 1][0]);
    var start = new Date(values[0][0]);
    ...
    annotatedtimeline.draw(data, {
        ...
        zoomStartTime: start, //NOTE: month 1 = Feb (javascript to blame)
        zoomEndTime: end, //NOTE: month 1 = Feb (javascript to blame)
        wmode: 'transparent'
    });
}