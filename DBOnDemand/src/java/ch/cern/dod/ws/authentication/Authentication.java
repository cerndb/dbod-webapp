 ...
 * 
 */
@WebServiceClient(name = "Authentication", targetNamespace = "https://winservices-soap.web.cern.ch/winservices-soap/Generic/Authentication.asmx", wsdlLocation = "classpath:/WEB-INF/wsdl/authentication.wsdl")
public class Authentication
    extends Service
{

    private final static URL AUTHENTICATION_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(ch.cern.dod.ws.authentication.Authentication.class.getName());

    static {
        AUTHENTICATION_WSDL_LOCATION = ch.cern.dod.ws.authentication.Authentication.class.getResource("/WEB-INF/wsdl/authentication.wsdl");
    }
