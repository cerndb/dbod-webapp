...
public class MemberTypeCode implements java.io.Serializable {
    ...
    public static final java.lang.String _DeviceInterface = "DeviceInterface";
    ...
    public static final MemberTypeCode DeviceInterface = new MemberTypeCode(_DeviceInterface);
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cra.web.cern.ch/cra/xml", "MemberTypeCode"));
    }
    /**
