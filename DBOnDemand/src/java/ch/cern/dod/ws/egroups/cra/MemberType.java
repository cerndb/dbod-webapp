...
public class MemberType  implements java.io.Serializable {
    ...
    private ch.cern.dod.ws.egroups.cra.MemberTypeCode type;
    ...
    public MemberType(
           java.lang.String ID,
           ch.cern.dod.ws.egroups.cra.MemberTypeCode type,
     ...
     * @return type
     */
    public ch.cern.dod.ws.egroups.cra.MemberTypeCode getType() {
        return type;
    }
     ...
     * @param type
     */
    public void setType(ch.cern.dod.ws.egroups.cra.MemberTypeCode type) {
        this.type = type;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://cra-ws.cern.ch/cra-ws/cra/", "MemberType"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://cra-ws.cern.ch/cra-ws/cra/", "MemberTypeCode"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://cra-ws.cern.ch/cra-ws/cra/", "Email"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://cra-ws.cern.ch/cra-ws/cra/", "PrimaryAccount"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
