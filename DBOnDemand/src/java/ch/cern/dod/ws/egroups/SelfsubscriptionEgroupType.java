...
public class SelfsubscriptionEgroupType  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://cra.web.cern.ch/cra/xml", "SelfsubscriptionEgroupType"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://cra.web.cern.ch/cra/xml", "ApprovalNeeded"));
